...
# Plugin-facing aliases per ADR-056 §D1 (Q1=B).
# `run_odr_trial` / `build_odr_config` remain the primary names; sub-slice 1
# adds the plugin-facing aliases without call-site churn. Sub-slice 3 may flip
# primary vs. alias when `ZetesisPlugin.research()` lands.
run_zetesis_research = run_odr_trial
build_zetesis_research_config = build_odr_config
