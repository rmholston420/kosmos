...
Module lifted to `plugins.zetesis.research.cove`. This shim aliases the
old import path to the new module via `sys.modules` so every existing
`from ops.benchmarks.adr_010.harness.cove import X` and
`from ops.benchmarks.adr_010.harness import cove` call site continues to
...
from plugins.zetesis.research import cove as _mod
