...
Module lifted to `plugins.zetesis.research.feature_grounding`. This shim aliases the
old import path to the new module via `sys.modules` so every existing
`from ops.benchmarks.adr_010.harness.feature_grounding import X` and
`from ops.benchmarks.adr_010.harness import feature_grounding` call site continues to
...
from plugins.zetesis.research import feature_grounding as _mod
