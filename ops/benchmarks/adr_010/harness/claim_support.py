...
Module lifted to `plugins.zetesis.research.claim_support`. This shim aliases the
old import path to the new module via `sys.modules` so every existing
`from ops.benchmarks.adr_010.harness.claim_support import X` and
`from ops.benchmarks.adr_010.harness import claim_support` call site continues to
...
from plugins.zetesis.research import claim_support as _mod
