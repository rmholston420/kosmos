...
Module lifted to `plugins.zetesis.research.structural_finalize`. This shim aliases the
old import path to the new module via `sys.modules` so every existing
`from ops.benchmarks.adr_010.harness.structural_finalize import X` and
`from ops.benchmarks.adr_010.harness import structural_finalize` call site continues to
...
from plugins.zetesis.research import structural_finalize as _mod
