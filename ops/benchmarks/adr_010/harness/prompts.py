...
Module lifted to `plugins.zetesis.research.prompts`. This shim aliases the
old import path to the new module via `sys.modules` so every existing
`from ops.benchmarks.adr_010.harness.prompts import X` and
`from ops.benchmarks.adr_010.harness import prompts` call site continues to
...
from plugins.zetesis.research import prompts as _mod
