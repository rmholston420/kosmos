...
Module lifted to `plugins.zetesis.research.license_grounding`. This shim aliases the
old import path to the new module via `sys.modules` so every existing
`from ops.benchmarks.adr_010.harness.license_grounding import X` and
`from ops.benchmarks.adr_010.harness import license_grounding` call site continues to
...
from plugins.zetesis.research import license_grounding as _mod
