...
Module lifted to `plugins.zetesis.research.rubric_critique`. This shim aliases the
old import path to the new module via `sys.modules` so every existing
`from ops.benchmarks.adr_010.harness.rubric_critique import X` and
`from ops.benchmarks.adr_010.harness import rubric_critique` call site continues to
...
from plugins.zetesis.research import rubric_critique as _mod
